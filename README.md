...
## 🛠️ Pre-requisites
Before running this project, ensure you have the following tools and configurations ready:
...
### 3. External Setup
* 📧 **Gmail App Password**: 16-character key for the SMTP Email Alert System.
...
* ⚙️ **Activity 2.2:** Feature Engineering for Heart Rate and SpO2
